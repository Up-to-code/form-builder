...
export default function TwitterLikeSignUpForm({ className, signUpWithEmail, clerkError, ...props }: SignUpFormProps) {
  ...
  return (
    <div
      className={cn("flex flex-col items-center justify-center min-h-screen bg-white dark:bg-gray-900", className)}
      {...props}
    >
      <Card className="w-full max-w-md bg-white dark:bg-gray-800 shadow-lg rounded-2xl">
        <CardContent className="p-8">
          ...
          <h1 className="mb-6 text-3xl font-bold text-gray-900 dark:text-white text-center">Create your account</h1>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {clerkError && <p className="text-red-500 text-sm text-center">{clerkError}</p>}
            <Button
              type="submit"
